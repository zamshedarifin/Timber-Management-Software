    ...
    <div class="col-lg-12 col-sm-12">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="background: #c6c8ca; color: #000000;">{{$view_lot->second}}</td>
                <td style="background: #c6c8ca; color: #000000;">{{$view_lot->third}}</td>
                <td style="background: #c6c8ca; color: #000000;">{{$view_lot->fourth}}</td>
                <td style="background: #c6c8ca; color: #000000;">{{$view_lot->five}}</td>
                <td style="background: #c6c8ca; color: #000000;">{{$view_lot->six}}</td>
                <td style="background: #c6c8ca; color: #000000;">{{$view_lot->seven}}</td>
